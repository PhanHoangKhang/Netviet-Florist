...
import { ArrowLeft, Phone, ShieldCheck, Truck, RefreshCw, MessageCircle } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[var(--color-bg-light)] py-20 text-center">
        ...
        <p className="text-xs text-gray-500 mt-2">Mẫu hoa này có thể đã dừng cung cấp hoặc sai đường dẫn.</p>
        <Link
          href="/san-pham"
  ...
  return (
    <div className="bg-[var(--color-bg-light)] min-h-screen py-8 sm:py-12">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mb-6 border-y border-gray-100 py-4">
                Sản phẩm được thiết kế tỉ mỉ từ những cành hoa tươi tuyển chọn trong ngày bởi thợ cắm hoa Nét Việt Florist. Phù hợp làm quà tặng sinh nhật, sự kiện, chúc mừng sang trọng.
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-[var(--color-primary)] text-white font-bold text-xs sm:text-sm hover:opacity-90 transition-opacity shadow-sm"
              >
                <MessageCircle className="w-4 h-4" />
                Đặt Tư Vấn Mẫu Này Qua Zalo
              </button>
      ...
      {/* Modal Lead Zalo khi bấm Đặt hoa */}
      <LeadModal
